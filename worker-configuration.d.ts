/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3346123be08188a7c53b8516fcc23f71)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AI: Ai;
		VALUE_FROM_CLOUDFLARE: "InvolveX's Dev Worker - dev.involvex.workers.dev";
		GH_TOKEN: string;
		...
		PLANETSCALE_ID: string;
		PLANETSCALE_TOKKEN: string;
		PLANETSCALE_Domain: string;
		PLANETSCALE_Redirect_URI: string;
		PLANETSCALE_CLIENT_ID_SECRET: string;
		NODE_ENV: string;
		DEV: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "GH_TOKEN" | "POSTHOG_API_KEY" | "ZAI_API_KEY" | "MINIMAX_API_KEY" | "SUPERMEMORY_API_KEY" | "SUPABASE_API_KEY" | "OPENROUTER_API_KEY" | "NANO_GPT_API_KEY" | "OVH_API_KEY" | "MISTRAL_API_KEY" | "QDRANT_API_KEY" | "KILO_API_KEY" | "MULEROUTER_API_KEY" | "BOT_TOKEN" | "TELEGRAM_CHAT_ID" | "WORKERS_AI_API_TOKEN" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_AI_GATEWAY_API_KEY" | "CLOUDFLARE_AI_GATEWAY_API_TOKEN" | "GEMINI_API_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "GITHUB_OAUTH_REDIRECT" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "ADMIN_USERNAME" | "ADMIN_PASSWORT" | "PLANETSCALE_ID" | "PLANETSCALE_TOKKEN" | "PLANETSCALE_Domain" | "PLANETSCALE_Redirect_URI" | "PLANETSCALE_CLIENT_ID_SECRET" | "NODE_ENV" | "DEV">> {}
}
